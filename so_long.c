...
int	end(t_game *game)
{
	...
	if (game->map != NULL)
	{
		...
		mlx_destroy_image(game->mlx_ptr, game->img.img_playerl);
		mlx_destroy_image(game->mlx_ptr, game->img.img_playerd);
		mlx_destroy_image(game->mlx_ptr, game->img.img_playerh);
